...
<link rel="stylesheet" type="text/css"
	href="css/componentCadUsuario.css" />
...
<body>
	...
	<div class="container">
		...
		<div id="reportar">
			...
			<form id="contactform" action="controladorUsuario" autocomplete="on"
				method="Post" onsubmit="validaForm();">
				<input type="hidden" name="acao" value="cadastrar"> <input
					type="hidden" name="tipo" value="cadastrar">

				<div class="field">
					<label for="name">Nome:*</label> <input type="text" class="input"
						name="nome" id="nome" required="required" />
					<p class="hint">Digite o nome.</p>
				</div>

				<div class="field">
					<label for="name">Email:*</label> <input type="email" class="input"
						name="emailCad" id="emailCad" required="required" />
					<p class="hint">Senha Atual.</p>
				</div>

				<div class="field">
					<label for="opcao">Perfil:</label> <select name="perfil">
				...
				<div class="field">
					<label for="name">Senha:*</label> <input type="password"
						class="input" name="senhaCad" id="senhaCad" required="required" />
					<p class="hint">Nova Senha.</p>
				</div>
				<div class="field">
					<label for="name">Confirmar Senha:*</label> <input type="password"
						class="input" name="confirmar" id="confirmar" required="required" />
					<p class="hint">Confime a Senha.</p>
				</div>

				<input type="reset" value="Limpar" class="button" /> <input
					type="submit" name="btnEnviar" class="button" value="Cadastrar"
	...
	<div id="home">
		<h2>
			<a href="controladorUsuario?acao=listar">Manuten&ccedil&atildeo
				Usu&aacute;rio</a>
		</h2>
	</div>
