					...
					<table>
						...
						<thead>
							<tr>
								...
								<th>Descricao
								<th>Status
								<th>A&ccedil&otildees <!--<tfoot> <tr> <th>Codigo <th>Tipo <th>Descricao <th> Status-->
						<tbody>
							<tr>
								<td>1010
								<td>Eletrico
								<td>Falta de luz em um poste
								<td>Aberto
								<td><a href="EditarReporte.html"> <img
										src="images/editar.gif" alt="editar reporte"
										title="editar reporte"></a> <a href="#"> <img
										src="images/excluir.png" alt="excluir reporte"
										title="excluir reporte"></a>
							<tr style="background: #ccc">
								<td>1020
								<td>Lixo
								<td>Rua com metralhas
								<td>Fechado
								<td><a href="EditarReporte.html"> <img
										src="images/editar.gif" alt="editar reporte"
										title="editar reporte"></a> <a href="#"> <img
