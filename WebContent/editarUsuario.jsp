			...
			<form id="contactform" action="controladorUsuario" method="post"
				...
				<div class="field">
					<label for="name">Nome:*</label> <input type="text" class="input"
						...
						value="<%=usuarioEditar.getNomeUsuario() %>" />
				...
				<div class="field">
					<label for="opcao">Perfil:</label> <select name="perfil">
						...
						<option value="Comum"
							<% if(usuarioEditar.getPerfilUsuario() == 2){  %> selected <%} %>>Comum</option>
						<option value="Operador"
							<% if(usuarioEditar.getPerfilUsuario() == 1){  %> selected <%} %>>Operador</option>
				...
				<div class="field">
					<label for="name">Senha Atual:*</label> <input type="text"
