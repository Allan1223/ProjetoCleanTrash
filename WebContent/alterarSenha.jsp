...
<body>
	...
	<div class="container">
		...
		<div id="manutencao">
			...
			<form id="contactform" name="registrar" action="controladorUsuario"
				method="post" onsubmit="validar();">

				<input type="hidden" name="acao" value="alterarSenha"> <input
					type="hidden" name="perfil" value="Comum"> <input
					type="hidden" name="emailUsuario"
					value="<%=usuario.getEmailUsuario()%>"> <input
					type="hidden" name="codigoUsuario"
					value="<%=usuario.getCodigoUsuario()%>">


				<div class="field">
					<label for="name">Email:*</label> <input type="text" class="input"
						name="email" id="email" required="required"
						value="<%=usuario.getEmailUsuario() %>" disabled />
				...
				<div class="field">
					<label for="name">Senha Atual:*</label> <input type="password"
						class="input" name="senhaAtual" id="senhaAtual"
						required="required" />
					<p class="hint">Senha Atual.</p>
				</div>
				<div class="field">
					<label for="name">Senha:*</label> <input type="password"
						class="input" name="senha" id="senha" required="required" />
